  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden flex items-center justify-center bg-[#f8fafc] px-6">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <p className="text-sm text-gray-400 mb-6">Sign up to start your personalized AI briefing.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-black text-sm font-medium text-white transition-all hover:bg-gray-800 disabled:opacity-60 disabled:hover:scale-100"
          >
        ...
        <button
          type="button"
          disabled={loading}
          className="flex h-12 w-full items-center justify-center gap-2 rounded-md border border-gray-200 bg-white text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60"
